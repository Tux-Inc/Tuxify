...
<template>
    <div class="h-screen w-full flex flex-col gap-4 items-center justify-center">
        <NuxtLink to="/">
            <svg class="h-16 fill-primary dark:fill-base-light" viewBox="0 0 2262 782" xmlns="http://www.w3.org/2000/svg">
        ...
        <UCard class=" w-full sm:w-1/2 md:w-1/3">
            ...
            >
                ...
                <UButton :label="i18n.t('auth.button.resetPassword')" block size="lg" icon="i-heroicons-envelope" type="submit" :loading="isLoading" />
