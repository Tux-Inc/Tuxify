...
<template>
    <header
        class="sticky top-0 z-50 border-b border-gray-200 dark:border-gray-800 bg-gray-50/75 dark:bg-base-dark/75 dark:bg-opacity-60 backdrop-blur">
            ...
            <div class="flex gap-2 items-center">
                <ClientOnly>
                    <UButton
                        ...
                        @click="isDark = !isDark"
                    />
                    <UDropdown class="ml-2.5" :items="localesItems"
