  ...
  <div>
      <div class="w-full h-px bg-gray-200 dark:bg-gray-800 flex items-center justify-center">
          <div class="bg-base-light dark:bg-gray-900 px-2">
              <svg class="h-8 w-8 fill-base-dark dark:fill-base-light" width="500" height="500" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M366.319 238.71V259.618H341.228C341.228 259.618 341.228 297.718 370.036 297.718C390.943 297.718 401.631 288.954 401.631 267.581C401.631 248.996 390.014 238.71 366.319 238.71Z"/>
              </svg>
          </div>
      </div>
